...
public class PHPArray<V> implements Iterable<V> {
  ...
  public void unset(String key) {
    ...
    if(toDelete==(head)&&toDelete==tail) {head=null;tail=null;}
    else if(toDelete==(tail)&&toDelete!=head )tail=toDelete.prev;
    else if(toDelete==head&&toDelete!=tail) head=head.next;
    else{
