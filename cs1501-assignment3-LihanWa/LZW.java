...
public class LZW {
    ...
    public static void compress() {
        CompressionCodeBookInterface codebook = 
            new DLBCodeBook(9, 16,flushIfFull);
        if(flushIfFull) BinaryStdOut.write(1, 1); 
    ...
    public static void expand() {
        ...
        ExpansionCodeBookInterface codebook = new ArrayCodeBook(9,16,flushIfFull);
        int f=(BinaryStdIn.readInt(1));
        if(f==1) flushIfFull=true;
